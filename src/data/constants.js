...
export const IDE_TARGETS = [
    ...
    },
    {
        ...
        name: "Claude Code",
        icon: "🧠",
        shortDesc: "Anthropic's terminal-native coding agent with Skills 2.0",
        rulesPath: ".claude/rules/blueprint.md",
        skillsPath: ".claude/skills/",
        workflowsPath: ".claude/workflows/",
        contextPath: ".context/",
        promptPath: ".claude/overview.md",
        guide: "Claude Code uses .claude/skills/ with SKILL.md files (YAML frontmatter + markdown body). Skills 2.0 supports progressive disclosure: name+description → body → linked files. Auto-invocation based on description field. Compliant with agentskills.io open standard.",
        configFormat: "markdown",
    },
    {
        id: "claude-cowork",
        name: "Claude Cowork",
        icon: "💼",
        shortDesc: "Anthropic's desktop agent for knowledge workers",
        rulesPath: ".claude/rules/blueprint.md",
        skillsPath: ".claude/skills/",
        workflowsPath: ".claude/workflows/",
        contextPath: ".context/",
        promptPath: ".claude/overview.md",
        guide: "Claude Cowork is a desktop agent for non-developers. Upload skills as ZIP in Settings > Capabilities > Skills. Uses same SKILL.md format as Claude Code. Skills can leverage connectors (Gmail, Slack, Calendar, Office 365). Focus skills on file management, document creation, and process automation.",
        configFormat: "markdown",
    },
];
...
export const TIERS = {
    free: {
        ...
        ideTargets: ["antigravity", "claude-cowork"],
        hasScanner: false,
        hasRefinement: false,
        hasExportZip: false,
    },
    pro: {
        ...
        ideTargets: ["antigravity", "cursor", "copilot", "windsurf", "claude-code", "claude-cowork"],
        hasScanner: true,
        hasRefinement: true,
        hasExportZip: true,
    },
